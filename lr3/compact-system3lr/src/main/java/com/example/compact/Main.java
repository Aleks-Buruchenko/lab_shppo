...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!type.equalsIgnoreCase("CPU") && !type.equalsIgnoreCase("RAM") && !type.equalsIgnoreCase("GPU")) {
                System.out.println("Неверный тип. Введите CPU, RAM, GPU или 'done'.");
                continue;
            }
        ...
        for (ComputingSystem system : systems) {
